<?php
  ...
  function validate_state($state, $errors=array()) {
    if (is_blank($state['name'])) {
      ...
      $errors[] = "Name may only contain characters: A-Z, a-z, and 0-9.";
    }
    ...
    if (is_blank($state['code'])) {
      ...
      $errors[] = "Code may only contain characters: A-Z, a-z, and 0-9.";
    }
    ...
    if (is_blank($state['country_id'])) {
      ...
      $errors[] = "Country ID may only contain characters: 0-9.";
    }
    return $errors;
  }
  ...
  function validate_territory($territory, $errors=array()) {
    ...
    if (is_blank($territory['position'])) {
      ...
      $errors[] = "Position may only contain characters: 0-9.";
    }
  ...
  function validate_salesperson($salesperson, $errors=array()) {
    ...
    if (is_blank($salesperson['phone'])) {
      ...
      $errors[] = "Phone may only contain characters: 0-9, spaces, and ()-";
    }
  ...
  function validate_user($user, $errors=array()) {
    ...
    if (is_blank($user['username'])) {
      ...
      $errors[] = "Username may only contain characters: A-Z, a-z, 0-9, and _.";
    }
    return $errors;
  }
